    ...
    <div className="flex items-end w-full lg:ml-[100px]">
      <div className="w-full lg:w-[90%]">
       ...
       <div className="relative">
          ...
          <Button className="!w-full bg-red-500 hover:bg-red-600 rounded py-6">
            Create Account
          </Button>
          <Button variant={"outline"} className="!w-full rounded py-6">
      ...
      `}
        ...
        <p className="text-muted-foreground text-sm text-center my-5">
          Already have account?
          <Link className="text-base linkLine pb-1 ml-3" href="/login">
            Log in
          </Link>
        </p>
      </div>
